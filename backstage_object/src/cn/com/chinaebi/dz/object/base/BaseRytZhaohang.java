...
/**
 * This is an object that contains data related to the ryt_zhaohang table.
...
public abstract class BaseRytZhaohang  implements Serializable {

	public static String REF = "RytZhaohang";
	 ...
	 */
	public BaseRytZhaohang (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytZhaohang)) return false;
		else {
			cn.com.chinaebi.dz.object.RytZhaohang rytZhaohang = (cn.com.chinaebi.dz.object.RytZhaohang) obj;
			if (null == this.getId() || null == rytZhaohang.getId()) return false;
			else return (this.getId().equals(rytZhaohang.getId()));
		}
	}
