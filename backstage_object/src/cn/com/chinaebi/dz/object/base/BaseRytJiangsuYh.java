...
/**
 * This is an object that contains data related to the ryt_jiangsu_yh table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="ryt_jiangsu_yh"
 */

public abstract class BaseRytJiangsuYh  implements Serializable {

	public static String REF = "RytJiangsuYh";
	 ...
	 */
	public BaseRytJiangsuYh (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytJiangsuYh)) return false;
		else {
			cn.com.chinaebi.dz.object.RytJiangsuYh rytJiangsuYh = (cn.com.chinaebi.dz.object.RytJiangsuYh) obj;
			if (null == this.getId() || null == rytJiangsuYh.getId()) return false;
			else return (this.getId().equals(rytJiangsuYh.getId()));
		}
	}
