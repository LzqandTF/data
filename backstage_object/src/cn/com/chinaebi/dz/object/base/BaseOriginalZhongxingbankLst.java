...
/**
 * This is an object that contains data related to the original_zhongxingbank_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="original_zhongxingbank_lst"
 */

public abstract class BaseOriginalZhongxingbankLst  implements Serializable {

	public static String REF = "OriginalZhongxingbankLst";
	...
	// constructors
	public BaseOriginalZhongxingbankLst () {
		initialize();
	}
	 ...
	 */
	public BaseOriginalZhongxingbankLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.OriginalZhongxingbankLst)) return false;
		else {
			cn.com.chinaebi.dz.object.OriginalZhongxingbankLst originalZhongxingbankLst = (cn.com.chinaebi.dz.object.OriginalZhongxingbankLst) obj;
			if (null == this.getId() || null == originalZhongxingbankLst.getId()) return false;
			else return (this.getId().equals(originalZhongxingbankLst.getId()));
		}
	}
