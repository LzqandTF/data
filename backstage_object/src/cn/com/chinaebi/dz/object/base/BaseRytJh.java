...
/**
 * This is an object that contains data related to the ryt_jh table.
...
public abstract class BaseRytJh  implements Serializable {

	public static String REF = "RytJh";
	 ...
	 */
	public BaseRytJh (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytJh)) return false;
		else {
			cn.com.chinaebi.dz.object.RytJh rytJh = (cn.com.chinaebi.dz.object.RytJh) obj;
			if (null == this.getId() || null == rytJh.getId()) return false;
			else return (this.getId().equals(rytJh.getId()));
		}
	}
