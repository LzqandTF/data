...
/**
 * This is an object that contains data related to the duizhang_jh_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="duizhang_jh_lst"
 */

public abstract class BaseDuizhangJhLst  implements Serializable {

	public static String REF = "DuizhangJhLst";
	 ...
	 */
	public BaseDuizhangJhLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.DuizhangJhLst)) return false;
		else {
			cn.com.chinaebi.dz.object.DuizhangJhLst duizhangJhLst = (cn.com.chinaebi.dz.object.DuizhangJhLst) obj;
			if (null == this.getId() || null == duizhangJhLst.getId()) return false;
			else return (this.getId().equals(duizhangJhLst.getId()));
		}
	}
