...
/**
 * This is an object that contains data related to the duizhang_beijingbank_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="duizhang_beijingbank_lst"
 */

public abstract class BaseDuizhangBeijingbankLst  implements Serializable {

	public static String REF = "DuizhangBeijingbankLst";
	...
	// constructors
	public BaseDuizhangBeijingbankLst () {
		initialize();
	}
	 ...
	 */
	public BaseDuizhangBeijingbankLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.DuizhangBeijingbankLst)) return false;
		else {
			cn.com.chinaebi.dz.object.DuizhangBeijingbankLst duizhangBeijingbankLst = (cn.com.chinaebi.dz.object.DuizhangBeijingbankLst) obj;
			if (null == this.getId() || null == duizhangBeijingbankLst.getId()) return false;
			else return (this.getId().equals(duizhangBeijingbankLst.getId()));
		}
	}
