CREATE TABLE `duizhang_jiangSuyh_lst` (
  ...
  `qsStatus` varchar(20) DEFAULT NULL,
  `qsResult` varchar(20) DEFAULT NULL,
  `merName` varchar(64) DEFAULT NULL,
  `orderStatus` varchar(20) DEFAULT NULL,
  `jsStatus` varchar(20) DEFAULT NULL,
  `jsDate` varchar(20) DEFAULT NULL,
  `qsDate` varchar(20) DEFAULT NULL,
  `inAccount` varchar(20) DEFAULT NULL,
  `outAccountName` varchar(20) DEFAULT NULL,
  `inAccountName` varchar(20) DEFAULT NULL,
