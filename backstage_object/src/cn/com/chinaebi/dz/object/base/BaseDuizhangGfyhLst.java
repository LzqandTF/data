...
/**
 * This is an object that contains data related to the duizhang_gfyh_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="duizhang_gfyh_lst"
 */

public abstract class BaseDuizhangGfyhLst  implements Serializable {

	public static String REF = "DuizhangGfyhLst";
	...
	public static String PROP_MER_STATUS = "MerStatus";
	 ...
	 */
	public BaseDuizhangGfyhLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	/**
	 * Return the value associated with the column: merStatus
	 */
	...
	/**
	 * Set the value related to the column: merStatus
	 * @param merStatus the merStatus value
	 */
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.DuizhangGfyhLst)) return false;
		else {
			cn.com.chinaebi.dz.object.DuizhangGfyhLst duizhangGfyhLst = (cn.com.chinaebi.dz.object.DuizhangGfyhLst) obj;
			if (null == this.getId() || null == duizhangGfyhLst.getId()) return false;
			else return (this.getId().equals(duizhangGfyhLst.getId()));
		}
	}
