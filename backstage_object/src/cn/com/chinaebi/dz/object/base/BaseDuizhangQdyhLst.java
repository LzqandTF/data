...
/**
 * This is an object that contains data related to the duizhang_qdyh_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="duizhang_qdyh_lst"
 */

public abstract class BaseDuizhangQdyhLst  implements Serializable {

	public static String REF = "DuizhangQdyhLst";
	 ...
	 */
	public BaseDuizhangQdyhLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	private java.lang.String tradeResult;
	...
	/**
	 * Return the value associated with the column: tradeResult
	 */
	public java.lang.String getTradeResult () {
		return tradeResult;
	}

	/**
	 * Set the value related to the column: tradeResult
	 * @param tradeResult the tradeResult value
	 */
	public void setTradeResult (java.lang.String tradeResult) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.DuizhangQdyhLst)) return false;
		else {
			cn.com.chinaebi.dz.object.DuizhangQdyhLst duizhangQdyhLst = (cn.com.chinaebi.dz.object.DuizhangQdyhLst) obj;
			if (null == this.getId() || null == duizhangQdyhLst.getId()) return false;
			else return (this.getId().equals(duizhangQdyhLst.getId()));
		}
	}
