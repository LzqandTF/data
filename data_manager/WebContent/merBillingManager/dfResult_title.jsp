...
<style>
    ...
    .menu ul li{ float:left; background:gray; list-style:none;  line-height:40px; height:40px;margin-right:5px;  }
...
<body>
	<div class="content">
		<div class="right" style="margin: -25px 5px;">
			<div class="menu">
				<ul>
					<li><a href="<%=request.getContextPath()%>/queryDfResultDataLst.do">结算到银行账户</a></li>
					<li><a href="<%=request.getContextPath()%>/queryDyDfResultDataLst.do">结算到电银账户</a></li>
				</ul>
			</div>
		</div>
	</div>
