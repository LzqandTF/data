...
/**
 * This is an object that contains data related to the original_dljh_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="original_dljh_lst"
 */

public abstract class BaseOriginalDljhLst  implements Serializable {

	public static String REF = "OriginalDljhLst";
	 ...
	 */
	public BaseOriginalDljhLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.OriginalDljhLst)) return false;
		else {
			cn.com.chinaebi.dz.object.OriginalDljhLst originalDljhLst = (cn.com.chinaebi.dz.object.OriginalDljhLst) obj;
			if (null == this.getId() || null == originalDljhLst.getId()) return false;
			else return (this.getId().equals(originalDljhLst.getId()));
		}
	}
