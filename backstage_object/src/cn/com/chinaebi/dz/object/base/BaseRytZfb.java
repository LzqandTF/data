...
/**
 * This is an object that contains data related to the ryt_zfb table.
...
public abstract class BaseRytZfb  implements Serializable {

	public static String REF = "RytZfb";
	 ...
	 */
	public BaseRytZfb (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytZfb)) return false;
		else {
			cn.com.chinaebi.dz.object.RytZfb rytZfb = (cn.com.chinaebi.dz.object.RytZfb) obj;
			if (null == this.getId() || null == rytZfb.getId()) return false;
			else return (this.getId().equals(rytZfb.getId()));
		}
	}
