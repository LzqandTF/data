...
/**
 * This is an object that contains data related to the duizhang_zfb_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="duizhang_zfb_lst"
 */

public abstract class BaseDuizhangZfbLst  implements Serializable {

	public static String REF = "DuizhangZfbLst";
	public static String PROP_PARTY_ACCOUNT = "PartyAccount";
	...
	public static String PROP_TRADING_CHANNEL = "TradingChannel";
	...
	public static String PROP_YW_TYPE = "YwType";


	// constructors
	public BaseDuizhangZfbLst () {
		initialize();
	}
	 ...
	 */
	public BaseDuizhangZfbLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	/**
	 * Return the value associated with the column: businessNo
	 */
	...
	/**
	 * Set the value related to the column: businessNo
	 * @param businessNo the businessNo value
	 */
	...
	/**
	 * Return the value associated with the column: partyAccount
	 */
	public java.lang.String getPartyAccount () {
		return partyAccount;
	}

	/**
	 * Set the value related to the column: partyAccount
	 * @param partyAccount the partyAccount value
	 */
	public void setPartyAccount (java.lang.String partyAccount) {
	...
	/**
	 * Return the value associated with the column: payAmount
	 */
	...
	/**
	 * Set the value related to the column: payAmount
	 * @param payAmount the payAmount value
	 */
	...
	/**
	 * Return the value associated with the column: balanceAmount
	 */
	...
	/**
	 * Set the value related to the column: balanceAmount
	 * @param balanceAmount the balanceAmount value
	 */
	...
	/**
	 * Return the value associated with the column: tradingChannel
	 */
	public java.lang.String getTradingChannel () {
		return tradingChannel;
	}

	/**
	 * Set the value related to the column: tradingChannel
	 * @param tradingChannel the tradingChannel value
	 */
	public void setTradingChannel (java.lang.String tradingChannel) {
	...
	/**
	 * Return the value associated with the column: yw_type
	 */
	...
	/**
	 * Set the value related to the column: yw_type
	 * @param ywType the yw_type value
	 */
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.DuizhangZfbLst)) return false;
		else {
			cn.com.chinaebi.dz.object.DuizhangZfbLst duizhangZfbLst = (cn.com.chinaebi.dz.object.DuizhangZfbLst) obj;
			if (null == this.getId() || null == duizhangZfbLst.getId()) return false;
			else return (this.getId().equals(duizhangZfbLst.getId()));
		}
	}
