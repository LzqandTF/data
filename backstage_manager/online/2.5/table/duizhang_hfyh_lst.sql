CREATE TABLE `duizhang_hfyh_lst` (
  ...
  `orderContent` varchar(20) DEFAULT NULL,
  `orderAmount` varchar(20) DEFAULT '0.00',
  `currency` varchar(20) DEFAULT NULL,
  `orderCommitTime` varchar(20) DEFAULT NULL,
  `tkCount` varchar(20) DEFAULT '0',
  `tkAmount` varchar(20) DEFAULT '0.00',
  `tkFee` varchar(20) DEFAULT '0.00',
  PRIMARY KEY (`id`),
