...
public interface RytUpmpDAO {
	 ...
	 * @return
	 */
	public boolean updateRytUpmp(String tseq,int bk_chk,boolean whetherQs,double zf_fee,String zf_file_fee,double mer_fee,Integer whetherReturnFee,Integer deductStlmDate);
	 ...
	 * @return List<RytUpmp>
	 */
	public List<RytUpmp> selectNoDzJsRytUpmp(Integer sysDate,Integer bk_chk,boolean whetherJs);
	 ...
	 * @return List<RytUpmp>
	 */
	public List<RytUpmp> selectNoDzJsIsSuccessRytUpmp(Integer sysDate,Integer bk_chk,boolean whetherJs,int tstat);
