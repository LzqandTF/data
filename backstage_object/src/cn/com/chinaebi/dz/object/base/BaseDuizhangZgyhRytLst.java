...
/**
 * This is an object that contains data related to the duizhang_zgyh_ryt_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="duizhang_zgyh_ryt_lst"
 */

public abstract class BaseDuizhangZgyhRytLst  implements Serializable {

	public static String REF = "DuizhangZgyhRytLst";
	 ...
	 */
	public BaseDuizhangZgyhRytLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.DuizhangZgyhRytLst)) return false;
		else {
			cn.com.chinaebi.dz.object.DuizhangZgyhRytLst duizhangZgyhRytLst = (cn.com.chinaebi.dz.object.DuizhangZgyhRytLst) obj;
			if (null == this.getId() || null == duizhangZgyhRytLst.getId()) return false;
			else return (this.getId().equals(duizhangZgyhRytLst.getId()));
		}
	}
