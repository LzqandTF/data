...
/**
 * This is an object that contains data related to the ryt_sjyh table.
...
public abstract class BaseRytSjyh  implements Serializable {

	public static String REF = "RytSjyh";
	 ...
	 */
	public BaseRytSjyh (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytSjyh)) return false;
		else {
			cn.com.chinaebi.dz.object.RytSjyh rytSjyh = (cn.com.chinaebi.dz.object.RytSjyh) obj;
			if (null == this.getId() || null == rytSjyh.getId()) return false;
			else return (this.getId().equals(rytSjyh.getId()));
		}
	}
