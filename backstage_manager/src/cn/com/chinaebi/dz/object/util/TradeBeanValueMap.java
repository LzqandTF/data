...
//	public static final String CHECKTIME = "checkTime";//审批时间
	...
	public static final String MERFEE = "merFee";
	public static final String ZFFEE = "zfFee";
	public static final String ZFFILEFEE = "zfFileFee";
...
//					value = StringUtils.isBlank(originalBeijingbank.getOriginalTradeTimeOfCancel(originalBeijingbankLst.getOriginalTransInfo(),originalBeijingbankLst.getTrademsgType(),originalBeijingbankLst.getDeductStlmDate().toString().substring(0, 10)))?"":originalBeijingbank.getOriginalTradeTimeOfCancel(originalBeijingbankLst.getOriginalTransInfo(),originalBeijingbankLst.getTrademsgType(),originalBeijingbankLst.getDeductStlmDate().toString().substring(0, 10));
					...
					value = originalBeijingbankLst.getZfFileFee();
				}else if(RECEIVI_NAME.equalsIgnoreCase(propertyName)){
					instInfoPK = new InstInfoPK(originalBeijingbankLst.getDeductSysId(),0);
					value = Backstage.getInstance().getInstInfo(instInfoPK).getReceiviName();
				}else if(DEDUCTSYSNAME.equalsIgnoreCase(propertyName)){
					instInfoPK = new InstInfoPK(originalBeijingbankLst.getDeductSysId(),0);
					value = Backstage.getInstance().getInstInfo(instInfoPK).getName();
				}else if(REQ_SYS_STANCE.equalsIgnoreCase(propertyName)){
				...
				}else if(MERNAME.equalsIgnoreCase(propertyName)){
					merBasic = Backstage.getInstance().getMerBasic(originalBeijingbankLst.getReqMerCode());
					value = merBasic==null?"":merBasic.getMerAbbreviation();
				}else if(MERFEE.equalsIgnoreCase(propertyName)){
					value = originalBeijingbankLst.getMerFee();
				}else if(ZFFEE.equalsIgnoreCase(propertyName)){
					value = originalBeijingbankLst.getZfFee();
				}
			}
			else
				log.error("70001 对应的对象 "+obj+" 错误");
			...
			if(obj instanceof OriginalZhongxingbankLst){
				...
				if(TRADE_AMOUNT.equalsIgnoreCase(propertyName)){
					...
					merBasic = Backstage.getInstance().getMerBasic(originalZhongxingbankLst.getReqMerCode());
					value = merBasic==null?"":merBasic.getMerAbbreviation();
				}else if(MERFEE.equalsIgnoreCase(propertyName)){
					value = originalZhongxingbankLst.getMerFee();
				}else if(ZFFEE.equalsIgnoreCase(propertyName)){
					value = originalZhongxingbankLst.getZfFee();
				}
			}
			else
				log.error("10 对应的对象 "+obj+" 错误");
...
//					value = originalCups.getOriginalTradeTimeOfCancel(originalCupsLst.getOriginalTransInfo(),originalCupsLst.getTrademsgType(),originalCupsLst.getDeductStlmDate().toString().substring(0, 10));
					...
					value = originalCupsLst.getZfFileFee();
				}else if(RECEIVI_NAME.equalsIgnoreCase(propertyName)){
					instInfoPK = new InstInfoPK(originalCupsLst.getDeductSysId(),0);
					value = Backstage.getInstance().getInstInfo(instInfoPK).getReceiviName();
				}else if(DEDUCTSYSNAME.equalsIgnoreCase(propertyName)){
					instInfoPK = new InstInfoPK(originalCupsLst.getDeductSysId(),0);
					value = Backstage.getInstance().getInstInfo(instInfoPK).getName();
					...
					merBasic = Backstage.getInstance().getMerBasic(originalCupsLst.getReqMerCode());
					value = merBasic==null?"":merBasic.getMerAbbreviation();
				}else if(MERFEE.equalsIgnoreCase(propertyName)){
					value = originalCupsLst.getMerFee();
				}else if(ZFFEE.equalsIgnoreCase(propertyName)){
					value = originalCupsLst.getZfFee();
				}
			}else
				log.error("11 对应的对象 "+obj+" 错误");
		}else if(instId == 14){
			if(obj instanceof OriginalDljhLst){
				...
				if(TRADE_AMOUNT.equalsIgnoreCase(propertyName)){
					...
					instInfoPK = new InstInfoPK(originalDljhLst.getDeductSysId(),0);
					value = Backstage.getInstance().getInstInfo(instInfoPK).getReceiviName();
				}else if(DEDUCTSYSNAME.equalsIgnoreCase(propertyName)){
					instInfoPK = new InstInfoPK(originalDljhLst.getDeductSysId(),0);
					value = Backstage.getInstance().getInstInfo(instInfoPK).getName();
					...
					merBasic = Backstage.getInstance().getMerBasic(originalDljhLst.getReqMerCode());
					value = merBasic==null?"":merBasic.getMerAbbreviation();
				}else if(MERFEE.equalsIgnoreCase(propertyName)){
					value = originalDljhLst.getMerFee();
				}else if(ZFFEE.equalsIgnoreCase(propertyName)){
					value = originalDljhLst.getZfFee();
				}
			}else
			...
			if(obj instanceof OriginalSzzhLst){
				...
				if(TRADE_AMOUNT.equalsIgnoreCase(propertyName)){
					...
					instInfoPK = new InstInfoPK(originalSzzhLst.getDeductSysId(),0);
					value = Backstage.getInstance().getInstInfo(instInfoPK).getReceiviName();
				}else if(DEDUCTSYSNAME.equalsIgnoreCase(propertyName)){
					instInfoPK = new InstInfoPK(originalSzzhLst.getDeductSysId(),0);
					value = Backstage.getInstance().getInstInfo(instInfoPK).getName();
					...
					merBasic = Backstage.getInstance().getMerBasic(originalSzzhLst.getReqMerCode());
					value = merBasic==null?"":merBasic.getMerAbbreviation();
				}else if(MERFEE.equalsIgnoreCase(propertyName)){
					value = originalSzzhLst.getMerFee();
				}else if(ZFFEE.equalsIgnoreCase(propertyName)){
					value = originalSzzhLst.getZfFee();
				}
			}else
				log.error("3对应的对象 "+obj+" 错误");
		}
...
//					value = "".equals(originalBeijingbank.getOriginalTradeTimeOfCancel(originalBeijingbankLst.getOriginalTransInfo(),originalBeijingbankLst.getTrademsgType(),originalBeijingbankLst.getDeductStlmDate().toString().substring(0, 10)))?"":originalCups.getOriginalTradeTimeOfCancel(originalBeijingbankLst.getOriginalTransInfo(),originalBeijingbankLst.getTrademsgType(),originalBeijingbankLst.getDeductStlmDate().toString().substring(0, 10));
					...
					instInfoPK = new InstInfoPK(originalBeijingbankLst.getDeductSysId(),0);
					value = new String(String.format("%-"+Integer.valueOf(columnLength)+"s",new String(Backstage.getInstance().getInstInfo(instInfoPK).getReceiviName().getBytes("GBK"),"ISO-8859-1")).getBytes("ISO-8859-1"),"GBK");
				}else if(DEDUCTSYSNAME.equalsIgnoreCase(propertyName)){
					instInfoPK = new InstInfoPK(originalBeijingbankLst.getDeductSysId(),0);
					value = new String(String.format("%-"+Integer.valueOf(columnLength)+"s",new String(Backstage.getInstance().getInstInfo(instInfoPK).getName().getBytes("GBK"),"ISO-8859-1")).getBytes("ISO-8859-1"),"GBK");
				}else if(TERMINAL_ID.equalsIgnoreCase(propertyName)){
					value = originalBeijingbankLst.getTerminalId();
				}else if(AGENTID.equalsIgnoreCase(propertyName)){
					value = originalBeijingbankLst.getAgentId();
					...
					merBasic = Backstage.getInstance().getMerBasic(originalBeijingbankLst.getReqMerCode());
					String mer_name = merBasic==null?"":merBasic.getMerAbbreviation();
					value = StringUtils.isBlank(mer_name)?"":new String(String.format("%-"+Integer.valueOf(columnLength)+"s",new String(mer_name.getBytes("GBK"),"ISO-8859-1")).getBytes("ISO-8859-1"),"GBK");
				}else if(MERFEE.equalsIgnoreCase(propertyName)){
					value = originalBeijingbankLst.getMerFee();
				}else if(ZFFEE.equalsIgnoreCase(propertyName)){
					value = originalBeijingbankLst.getZfFee();
...
//								original_trade_time = originalBeijingbank.getOriginalTradeTimeOfCancel(errorDataLst.getOriginalTransInfo(),errorDataLst.getTrademsgType(),errorDataLst.getDeductStlmDate().toString().substring(0, 10));
					...
					instInfoPK = new InstInfoPK(errorDataLst.getDeductSysId(),errorDataLst.getInstType());
					value = new String(String.format("%-"+Integer.valueOf(columnLength)+"s",new String(Backstage.getInstance().getInstInfo(instInfoPK).getReceiviName().getBytes("GBK"),"ISO-8859-1")).getBytes("ISO-8859-1"),"GBK");
				}else if(DEDUCTSYSNAME.equalsIgnoreCase(propertyName)){
					instInfoPK = new InstInfoPK(errorDataLst.getDeductSysId(),errorDataLst.getInstType());
					value = new String(String.format("%-"+Integer.valueOf(columnLength)+"s",new String(Backstage.getInstance().getInstInfo(instInfoPK).getName().getBytes("GBK"),"ISO-8859-1")).getBytes("ISO-8859-1"),"GBK");
					...
					merBasic = Backstage.getInstance().getMerBasic(errorDataLst.getReqMerCode());
					String mer_name = merBasic==null?"":merBasic.getMerAbbreviation();
					value = StringUtils.isBlank(mer_name)?"":new String(String.format("%-"+Integer.valueOf(columnLength)+"s",new String(mer_name.getBytes("GBK"),"ISO-8859-1")).getBytes("ISO-8859-1"),"GBK");
				}else if(MERFEE.equalsIgnoreCase(propertyName)){
					value = errorDataLst.getMerFee();
				}else if(ZFFEE.equalsIgnoreCase(propertyName)){
					value = errorDataLst.getZfFee();
				}else if(ZFFILEFEE.equalsIgnoreCase(propertyName)){
					value = errorDataLst.getZfFileFee();
				}else if(GATE.equalsIgnoreCase(propertyName)){
					instInfoPK = new InstInfoPK(errorDataLst.getDeductSysId(),errorDataLst.getInstType());
					value = Backstage.getInstance().getInstInfo(instInfoPK).getGate(); 
				}
		}
		return value;
	}
			...
			if(obj instanceof RytUpmp){
				rytUpmp = (RytUpmp)obj;
				 if(ID.equalsIgnoreCase(propertyName)){
					 ...
					 instInfoPK = new InstInfoPK(rytUpmp.getGid(),1);
					 value = Backstage.getInstance().getInstInfo(instInfoPK).getName();
				 }else if(TRADETYPEINCHINESE.equalsIgnoreCase(propertyName)){
