CREATE TABLE `mer_fund_stance` (
  ...
  `trade_amount` float(20,2) NOT NULL DEFAULT '0.00',
  `mer_fee` float(20,2) NOT NULL DEFAULT '0.00',
  `change_amount` float(20,2) NOT NULL DEFAULT '0.00',
  `account_amount` float(20,2) NOT NULL DEFAULT '0.00',
