...
/**
 * This is an object that contains data related to the ryt_upmp table.
...
public abstract class BaseRytUpmp  implements Serializable {

	public static String REF = "RytUpmp";
	 ...
	 */
	public BaseRytUpmp (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytUpmp)) return false;
		else {
			cn.com.chinaebi.dz.object.RytUpmp rytUpmp = (cn.com.chinaebi.dz.object.RytUpmp) obj;
			if (null == this.getId() || null == rytUpmp.getId()) return false;
			else return (this.getId().equals(rytUpmp.getId()));
		}
	}
