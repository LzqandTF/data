...
/**
 * This is an object that contains data related to the ryt_qingdao_yh table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="ryt_qingdao_yh"
 */

public abstract class BaseRytQingdaoYh  implements Serializable {

	public static String REF = "RytQingdaoYh";
	 ...
	 */
	public BaseRytQingdaoYh (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytQingdaoYh)) return false;
		else {
			cn.com.chinaebi.dz.object.RytQingdaoYh rytQingdaoYh = (cn.com.chinaebi.dz.object.RytQingdaoYh) obj;
			if (null == this.getId() || null == rytQingdaoYh.getId()) return false;
			else return (this.getId().equals(rytQingdaoYh.getId()));
		}
	}
