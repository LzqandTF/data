...
/**
 * This is an object that contains data related to the duizhang_gdyh_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="duizhang_gdyh_lst"
 */

public abstract class BaseDuizhangGdyhLst  implements Serializable {

	public static String REF = "DuizhangGdyhLst";
	...
	public static String PROP_QS_AMOUNT = "QsAmount";
	...
	public static String PROP_BANK_SEQ = "BankSeq";
	 ...
	 */
	public BaseDuizhangGdyhLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	private java.lang.String qsAmount;
	private java.lang.String remark;
	private java.lang.String bankSeq;
	...
	/**
	 * Return the value associated with the column: qsAmount
	 */
	public java.lang.String getQsAmount () {
		return qsAmount;
	}

	/**
	 * Set the value related to the column: qsAmount
	 * @param qsAmount the qsAmount value
	 */
	public void setQsAmount (java.lang.String qsAmount) {
	...
	/**
	 * Return the value associated with the column: bankSeq
	 */
	...
	/**
	 * Set the value related to the column: bankSeq
	 * @param bankSeq the bankSeq value
	 */
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.DuizhangGdyhLst)) return false;
		else {
			cn.com.chinaebi.dz.object.DuizhangGdyhLst duizhangGdyhLst = (cn.com.chinaebi.dz.object.DuizhangGdyhLst) obj;
			if (null == this.getId() || null == duizhangGdyhLst.getId()) return false;
			else return (this.getId().equals(duizhangGdyhLst.getId()));
		}
	}
