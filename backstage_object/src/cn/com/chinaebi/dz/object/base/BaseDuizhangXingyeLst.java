...
/**
 * This is an object that contains data related to the duizhang_xingye_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="duizhang_xingye_lst"
 */

public abstract class BaseDuizhangXingyeLst  implements Serializable {

	public static String REF = "DuizhangXingyeLst";
	 ...
	 */
	public BaseDuizhangXingyeLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.DuizhangXingyeLst)) return false;
		else {
			cn.com.chinaebi.dz.object.DuizhangXingyeLst duizhangXingyeLst = (cn.com.chinaebi.dz.object.DuizhangXingyeLst) obj;
			if (null == this.getId() || null == duizhangXingyeLst.getId()) return false;
			else return (this.getId().equals(duizhangXingyeLst.getId()));
		}
	}
