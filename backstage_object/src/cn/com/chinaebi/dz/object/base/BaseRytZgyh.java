...
/**
 * This is an object that contains data related to the ryt_zgyh table.
...
public abstract class BaseRytZgyh  implements Serializable {

	public static String REF = "RytZgyh";
	 ...
	 */
	public BaseRytZgyh (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytZgyh)) return false;
		else {
			cn.com.chinaebi.dz.object.RytZgyh rytZgyh = (cn.com.chinaebi.dz.object.RytZgyh) obj;
			if (null == this.getId() || null == rytZgyh.getId()) return false;
			else return (this.getId().equals(rytZgyh.getId()));
		}
	}
