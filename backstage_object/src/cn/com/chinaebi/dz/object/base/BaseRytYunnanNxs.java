...
/**
 * This is an object that contains data related to the ryt_yunnan_nxs table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="ryt_yunnan_nxs"
 */

public abstract class BaseRytYunnanNxs  implements Serializable {

	public static String REF = "RytYunnanNxs";
	 ...
	 */
	public BaseRytYunnanNxs (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytYunnanNxs)) return false;
		else {
			cn.com.chinaebi.dz.object.RytYunnanNxs rytYunnanNxs = (cn.com.chinaebi.dz.object.RytYunnanNxs) obj;
			if (null == this.getId() || null == rytYunnanNxs.getId()) return false;
			else return (this.getId().equals(rytYunnanNxs.getId()));
		}
	}
