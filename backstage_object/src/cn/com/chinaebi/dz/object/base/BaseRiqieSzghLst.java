...
/**
 * This is an object that contains data related to the riqie_szgh_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="riqie_szgh_lst"
 */

public abstract class BaseRiqieSzghLst  implements Serializable {

	public static String REF = "RiqieSzghLst";
	 ...
	 */
	public BaseRiqieSzghLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RiqieSzghLst)) return false;
		else {
			cn.com.chinaebi.dz.object.RiqieSzghLst riqieSzghLst = (cn.com.chinaebi.dz.object.RiqieSzghLst) obj;
			if (null == this.getId() || null == riqieSzghLst.getId()) return false;
			else return (this.getId().equals(riqieSzghLst.getId()));
		}
	}
