package cn.com.chinaebi.ryt.nyyh.dz.deal;
 ...
 */
public class RytNyyhBankTradeDz implements TradeDzHandler {
				...
				if(duizhangList != null && duizhangList.size() > 0){
					...
					if(objMap != null && tseqMap != null && tseqMap.keySet().size() > 0){
						...
						for (Object object : duizhangList) {
							...
							//对账数据匹配原始交易数据
							//Object[] oriObj = hlogDAO.queryOriginalData(orderId, orderId, originalTableName,instId, DataStatus.flag_2);
							if(oriObj != null){
								/*
