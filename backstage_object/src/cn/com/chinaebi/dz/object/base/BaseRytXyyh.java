...
/**
 * This is an object that contains data related to the ryt_xyyh table.
...
public abstract class BaseRytXyyh  implements Serializable {

	public static String REF = "RytXyyh";
	 ...
	 */
	public BaseRytXyyh (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytXyyh)) return false;
		else {
			cn.com.chinaebi.dz.object.RytXyyh rytXyyh = (cn.com.chinaebi.dz.object.RytXyyh) obj;
			if (null == this.getId() || null == rytXyyh.getId()) return false;
			else return (this.getId().equals(rytXyyh.getId()));
		}
	}
