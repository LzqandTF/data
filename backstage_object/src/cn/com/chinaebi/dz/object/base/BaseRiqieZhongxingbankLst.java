...
/**
 * This is an object that contains data related to the riqie_zhongxingbank_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="riqie_zhongxingbank_lst"
 */

public abstract class BaseRiqieZhongxingbankLst  implements Serializable {

	public static String REF = "RiqieZhongxingbankLst";
	...
	// constructors
	public BaseRiqieZhongxingbankLst () {
		initialize();
	}
	 ...
	 */
	public BaseRiqieZhongxingbankLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RiqieZhongxingbankLst)) return false;
		else {
			cn.com.chinaebi.dz.object.RiqieZhongxingbankLst riqieZhongxingbankLst = (cn.com.chinaebi.dz.object.RiqieZhongxingbankLst) obj;
			if (null == this.getId() || null == riqieZhongxingbankLst.getId()) return false;
			else return (this.getId().equals(riqieZhongxingbankLst.getId()));
		}
	}
