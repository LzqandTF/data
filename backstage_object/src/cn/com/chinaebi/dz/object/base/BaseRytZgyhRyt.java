...
/**
 * This is an object that contains data related to the ryt_zgyh_ryt table.
...
public abstract class BaseRytZgyhRyt  implements Serializable {

	public static String REF = "RytZgyhRyt";
	 ...
	 */
	public BaseRytZgyhRyt (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytZgyhRyt)) return false;
		else {
			cn.com.chinaebi.dz.object.RytZgyhRyt rytZgyhRyt = (cn.com.chinaebi.dz.object.RytZgyhRyt) obj;
			if (null == this.getId() || null == rytZgyhRyt.getId()) return false;
			else return (this.getId().equals(rytZgyhRyt.getId()));
		}
	}
