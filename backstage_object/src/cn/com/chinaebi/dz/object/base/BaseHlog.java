...
/**
 * This is an object that contains data related to the hlog table.
...
public abstract class BaseHlog  implements Serializable {

	public static String REF = "Hlog";
	...
	public static String PROP_AGAIN_PAY_DATE = "AgainPayDate";
	 ...
	 */
	public BaseHlog (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.Hlog)) return false;
		else {
			cn.com.chinaebi.dz.object.Hlog hlog = (cn.com.chinaebi.dz.object.Hlog) obj;
			if (null == this.getId() || null == hlog.getId()) return false;
			else return (this.getId().equals(hlog.getId()));
		}
	}
