...
/**
 * This is an object that contains data related to the duizhang_zhxt_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="duizhang_zhxt_lst"
 */

public abstract class BaseDuizhangZhxtLst  implements Serializable {

	public static String REF = "DuizhangZhxtLst";
	 ...
	 */
	public BaseDuizhangZhxtLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.DuizhangZhxtLst)) return false;
		else {
			cn.com.chinaebi.dz.object.DuizhangZhxtLst duizhangZhxtLst = (cn.com.chinaebi.dz.object.DuizhangZhxtLst) obj;
			if (null == this.getId() || null == duizhangZhxtLst.getId()) return false;
			else return (this.getId().equals(duizhangZhxtLst.getId()));
		}
	}
