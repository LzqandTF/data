...
/**
 * This is an object that contains data related to the duizhang_error_upmp_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="duizhang_error_upmp_lst"
 */

public abstract class BaseDuizhangErrorUpmpLst  implements Serializable {

	public static String REF = "DuizhangErrorUpmpLst";
	...
	// constructors
	public BaseDuizhangErrorUpmpLst () {
		initialize();
	}
	 ...
	 */
	public BaseDuizhangErrorUpmpLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.DuizhangErrorUpmpLst)) return false;
		else {
			cn.com.chinaebi.dz.object.DuizhangErrorUpmpLst duizhangErrorUpmpLst = (cn.com.chinaebi.dz.object.DuizhangErrorUpmpLst) obj;
			if (null == this.getId() || null == duizhangErrorUpmpLst.getId()) return false;
			else return (this.getId().equals(duizhangErrorUpmpLst.getId()));
		}
	}
