...
/**
 * This is an object that contains data related to the trade_lst table.
...
public abstract class BaseTradeLst  implements Serializable {

	public static String REF = "TradeLst";
	 ...
	 */
	public BaseTradeLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.TradeLst)) return false;
		else {
			cn.com.chinaebi.dz.object.TradeLst tradeLst = (cn.com.chinaebi.dz.object.TradeLst) obj;
			if (null == this.getId() || null == tradeLst.getId()) return false;
			else return (this.getId().equals(tradeLst.getId()));
		}
	}
