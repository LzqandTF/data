...
/**
 * This is an object that contains data related to the riqie_beijingbank_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="riqie_beijingbank_lst"
 */

public abstract class BaseRiqieBeijingbankLst  implements Serializable {

	public static String REF = "RiqieBeijingbankLst";
	...
	// constructors
	public BaseRiqieBeijingbankLst () {
		initialize();
	}
	 ...
	 */
	public BaseRiqieBeijingbankLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RiqieBeijingbankLst)) return false;
		else {
			cn.com.chinaebi.dz.object.RiqieBeijingbankLst riqieBeijingbankLst = (cn.com.chinaebi.dz.object.RiqieBeijingbankLst) obj;
			if (null == this.getId() || null == riqieBeijingbankLst.getId()) return false;
			else return (this.getId().equals(riqieBeijingbankLst.getId()));
		}
	}
