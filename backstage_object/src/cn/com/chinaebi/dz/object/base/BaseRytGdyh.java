...
/**
 * This is an object that contains data related to the ryt_gdyh table.
...
public abstract class BaseRytGdyh  implements Serializable {

	public static String REF = "RytGdyh";
	 ...
	 */
	public BaseRytGdyh (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytGdyh)) return false;
		else {
			cn.com.chinaebi.dz.object.RytGdyh rytGdyh = (cn.com.chinaebi.dz.object.RytGdyh) obj;
			if (null == this.getId() || null == rytGdyh.getId()) return false;
			else return (this.getId().equals(rytGdyh.getId()));
		}
	}
