...
/**
 * This is an object that contains data related to the duizhang_msyh_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="duizhang_msyh_lst"
 */

public abstract class BaseDuizhangMsyhLst  implements Serializable {

	public static String REF = "DuizhangMsyhLst";
	 ...
	 */
	public BaseDuizhangMsyhLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.DuizhangMsyhLst)) return false;
		else {
			cn.com.chinaebi.dz.object.DuizhangMsyhLst duizhangMsyhLst = (cn.com.chinaebi.dz.object.DuizhangMsyhLst) obj;
			if (null == this.getId() || null == duizhangMsyhLst.getId()) return false;
			else return (this.getId().equals(duizhangMsyhLst.getId()));
		}
	}
