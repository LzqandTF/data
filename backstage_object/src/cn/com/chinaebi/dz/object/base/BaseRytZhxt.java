...
/**
 * This is an object that contains data related to the ryt_zhxt table.
...
public abstract class BaseRytZhxt  implements Serializable {

	public static String REF = "RytZhxt";
	 ...
	 */
	public BaseRytZhxt (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytZhxt)) return false;
		else {
			cn.com.chinaebi.dz.object.RytZhxt rytZhxt = (cn.com.chinaebi.dz.object.RytZhxt) obj;
			if (null == this.getId() || null == rytZhxt.getId()) return false;
			else return (this.getId().equals(rytZhxt.getId()));
		}
	}
