...
/**
 * This is an object that contains data related to the ryt_yl table.
...
public abstract class BaseRytYl  implements Serializable {

	public static String REF = "RytYl";
	 ...
	 */
	public BaseRytYl (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytYl)) return false;
		else {
			cn.com.chinaebi.dz.object.RytYl rytYl = (cn.com.chinaebi.dz.object.RytYl) obj;
			if (null == this.getId() || null == rytYl.getId()) return false;
			else return (this.getId().equals(rytYl.getId()));
		}
	}
