package cn.com.chinaebi.ryt.kq.dz.deal;
 ...
 */
public class RytKqBankTradeDz implements TradeDzHandler {
				...
				if(duizhangList != null && duizhangList.size() > 0){
					...
					if(objMap != null && tseqMap != null && tseqMap.keySet().size() > 0){
						...
						for (Object object : duizhangList) {
							...
							String zf_file_fee = dzObj[2] == null ? "0" : dzObj[2].toString();
							...
							//对账数据匹配原始交易数据
							//Object[] oriObj = hlogDAO.queryOriginalData(reqSysStance, orderId, originalTableName,instId, DataStatus.flag_0);
							if(oriObj != null){
								/*
