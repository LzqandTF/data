...
/**
 * This is an object that contains data related to the riqie_dljh_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="riqie_dljh_lst"
 */

public abstract class BaseRiqieDljhLst  implements Serializable {

	public static String REF = "RiqieDljhLst";
	 ...
	 */
	public BaseRiqieDljhLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RiqieDljhLst)) return false;
		else {
			cn.com.chinaebi.dz.object.RiqieDljhLst riqieDljhLst = (cn.com.chinaebi.dz.object.RiqieDljhLst) obj;
			if (null == this.getId() || null == riqieDljhLst.getId()) return false;
			else return (this.getId().equals(riqieDljhLst.getId()));
		}
	}
