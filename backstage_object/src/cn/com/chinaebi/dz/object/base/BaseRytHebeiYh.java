...
/**
 * This is an object that contains data related to the ryt_hebei_yh table.
...
public abstract class BaseRytHebeiYh  implements Serializable {

	public static String REF = "RytHebeiYh";
	 ...
	 */
	public BaseRytHebeiYh (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytHebeiYh)) return false;
		else {
			cn.com.chinaebi.dz.object.RytHebeiYh rytHebeiYh = (cn.com.chinaebi.dz.object.RytHebeiYh) obj;
			if (null == this.getId() || null == rytHebeiYh.getId()) return false;
			else return (this.getId().equals(rytHebeiYh.getId()));
		}
	}
