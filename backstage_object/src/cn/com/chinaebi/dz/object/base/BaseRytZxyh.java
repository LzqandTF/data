...
/**
 * This is an object that contains data related to the ryt_zxyh table.
...
public abstract class BaseRytZxyh  implements Serializable {

	public static String REF = "RytZxyh";
	 ...
	 */
	public BaseRytZxyh (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytZxyh)) return false;
		else {
			cn.com.chinaebi.dz.object.RytZxyh rytZxyh = (cn.com.chinaebi.dz.object.RytZxyh) obj;
			if (null == this.getId() || null == rytZxyh.getId()) return false;
			else return (this.getId().equals(rytZxyh.getId()));
		}
	}
