...
/**
 * This is an object that contains data related to the original_cups_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="original_cups_lst"
 */

public abstract class BaseOriginalCupsLst  implements Serializable {

	public static String REF = "OriginalCupsLst";
	 ...
	 */
	public BaseOriginalCupsLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.OriginalCupsLst)) return false;
		else {
			cn.com.chinaebi.dz.object.OriginalCupsLst originalCupsLst = (cn.com.chinaebi.dz.object.OriginalCupsLst) obj;
			if (null == this.getId() || null == originalCupsLst.getId()) return false;
			else return (this.getId().equals(originalCupsLst.getId()));
		}
	}
