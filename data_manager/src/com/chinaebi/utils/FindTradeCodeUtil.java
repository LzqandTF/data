...
public class FindTradeCodeUtil {
	...
	private Logger logger = LoggerFactory.getLogger(FindTradeCodeUtil.class);
	 ...
	 * @return String
	 */
	public String findTradeCodeName(String tradeCode,TradeTypeService tradeTypeService){
		String tradeCodeName = null;
		if(StringUtils.isNotBlank(tradeCode) && tradeTypeService != null){
			tradeCodeName = tradeTypeService.queryTradeType(tradeCode);
	...
	public String returnTradeCodeName(String terminalInfo,TradeTypeService tradeTypeService){
		String tradeCode = tradeCodeSubString(terminalInfo);
		return findTradeCodeName(tradeCode,tradeTypeService);
	}
