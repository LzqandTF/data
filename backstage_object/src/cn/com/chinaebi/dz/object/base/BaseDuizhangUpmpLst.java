...
/**
 * This is an object that contains data related to the duizhang_upmp_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="duizhang_upmp_lst"
 */

public abstract class BaseDuizhangUpmpLst  implements Serializable {

	public static String REF = "DuizhangUpmpLst";
	 ...
	 */
	public BaseDuizhangUpmpLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.DuizhangUpmpLst)) return false;
		else {
			cn.com.chinaebi.dz.object.DuizhangUpmpLst duizhangUpmpLst = (cn.com.chinaebi.dz.object.DuizhangUpmpLst) obj;
			if (null == this.getId() || null == duizhangUpmpLst.getId()) return false;
			else return (this.getId().equals(duizhangUpmpLst.getId()));
		}
	}
