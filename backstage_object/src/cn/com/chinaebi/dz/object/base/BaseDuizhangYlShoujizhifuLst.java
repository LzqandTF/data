...
/**
 * This is an object that contains data related to the duizhang_yl_shoujizhifu_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="duizhang_yl_shoujizhifu_lst"
 */

public abstract class BaseDuizhangYlShoujizhifuLst  implements Serializable {

	public static String REF = "DuizhangYlShoujizhifuLst";
	...
	public static String PROP_SYSTEMTRACKING_NO = "SystemtrackingNo";
	...
	public static String PROP_CARD_ISSUERS = "CardIssuers";


	// constructors
	public BaseDuizhangYlShoujizhifuLst () {
		initialize();
	}
	 ...
	 */
	public BaseDuizhangYlShoujizhifuLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	private java.lang.String cardIssuers;
	...
	private java.lang.String systemtrackingNo;
	...
	/**
	 * Return the value associated with the column: cardIssuers
	 */
	public java.lang.String getCardIssuers () {
		return cardIssuers;
	}

	/**
	 * Set the value related to the column: cardIssuers
	 * @param cardIssuers the cardIssuers value
	 */
	public void setCardIssuers (java.lang.String cardIssuers) {
	...
	/**
	 * Return the value associated with the column: systemtrackingNo
	 */
	public java.lang.String getSystemtrackingNo () {
		return systemtrackingNo;
	}

	/**
	 * Set the value related to the column: systemtrackingNo
	 * @param systemtrackingNo the systemtrackingNo value
	 */
	public void setSystemtrackingNo (java.lang.String systemtrackingNo) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.DuizhangYlShoujizhifuLst)) return false;
		else {
			cn.com.chinaebi.dz.object.DuizhangYlShoujizhifuLst duizhangYlShoujizhifuLst = (cn.com.chinaebi.dz.object.DuizhangYlShoujizhifuLst) obj;
			if (null == this.getId() || null == duizhangYlShoujizhifuLst.getId()) return false;
			else return (this.getId().equals(duizhangYlShoujizhifuLst.getId()));
		}
	}
