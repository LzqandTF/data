...
/**
 * This is an object that contains data related to the ryt_pufa table.
...
public abstract class BaseRytPufa  implements Serializable {

	public static String REF = "RytPufa";
	 ...
	 */
	public BaseRytPufa (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytPufa)) return false;
		else {
			cn.com.chinaebi.dz.object.RytPufa rytPufa = (cn.com.chinaebi.dz.object.RytPufa) obj;
			if (null == this.getId() || null == rytPufa.getId()) return false;
			else return (this.getId().equals(rytPufa.getId()));
		}
	}
