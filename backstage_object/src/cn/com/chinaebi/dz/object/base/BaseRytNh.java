...
/**
 * This is an object that contains data related to the ryt_nh table.
...
public abstract class BaseRytNh  implements Serializable {

	public static String REF = "RytNh";
	 ...
	 */
	public BaseRytNh (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytNh)) return false;
		else {
			cn.com.chinaebi.dz.object.RytNh rytNh = (cn.com.chinaebi.dz.object.RytNh) obj;
			if (null == this.getId() || null == rytNh.getId()) return false;
			else return (this.getId().equals(rytNh.getId()));
		}
	}
