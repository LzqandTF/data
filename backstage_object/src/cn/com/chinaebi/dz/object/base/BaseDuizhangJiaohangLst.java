...
/**
 * This is an object that contains data related to the duizhang_jiaohang_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="duizhang_jiaohang_lst"
 */

public abstract class BaseDuizhangJiaohangLst  implements Serializable {

	public static String REF = "DuizhangJiaohangLst";
	...
	// constructors
	public BaseDuizhangJiaohangLst () {
		initialize();
	}
	 ...
	 */
	public BaseDuizhangJiaohangLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.DuizhangJiaohangLst)) return false;
		else {
			cn.com.chinaebi.dz.object.DuizhangJiaohangLst duizhangJiaohangLst = (cn.com.chinaebi.dz.object.DuizhangJiaohangLst) obj;
			if (null == this.getId() || null == duizhangJiaohangLst.getId()) return false;
			else return (this.getId().equals(duizhangJiaohangLst.getId()));
		}
	}
