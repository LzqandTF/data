...
public interface ErrorDataLstService {
	...
	public abstract int updateHandlingStatus(HttpServletRequest request, ErrorDataLst errorDataLst);
	...
	public abstract List<ErrorDataLst> queryErrorDataLst(Map<String, Object> map);
