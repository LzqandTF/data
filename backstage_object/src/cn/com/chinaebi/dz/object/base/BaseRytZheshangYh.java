...
/**
 * This is an object that contains data related to the ryt_zheshang_yh table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="ryt_zheshang_yh"
 */

public abstract class BaseRytZheshangYh  implements Serializable {

	public static String REF = "RytZheshangYh";
	 ...
	 */
	public BaseRytZheshangYh (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytZheshangYh)) return false;
		else {
			cn.com.chinaebi.dz.object.RytZheshangYh rytZheshangYh = (cn.com.chinaebi.dz.object.RytZheshangYh) obj;
			if (null == this.getId() || null == rytZheshangYh.getId()) return false;
			else return (this.getId().equals(rytZheshangYh.getId()));
		}
	}
