...
/**
 * This is an object that contains data related to the ryt_bjyh table.
...
public abstract class BaseRytBjyh  implements Serializable {

	public static String REF = "RytBjyh";
	 ...
	 */
	public BaseRytBjyh (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytBjyh)) return false;
		else {
			cn.com.chinaebi.dz.object.RytBjyh rytBjyh = (cn.com.chinaebi.dz.object.RytBjyh) obj;
			if (null == this.getId() || null == rytBjyh.getId()) return false;
			else return (this.getId().equals(rytBjyh.getId()));
		}
	}
