...
/**
 * This is an object that contains data related to the ryt_jsyh table.
...
public abstract class BaseRytJsyh  implements Serializable {

	public static String REF = "RytJsyh";
	 ...
	 */
	public BaseRytJsyh (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytJsyh)) return false;
		else {
			cn.com.chinaebi.dz.object.RytJsyh rytJsyh = (cn.com.chinaebi.dz.object.RytJsyh) obj;
			if (null == this.getId() || null == rytJsyh.getId()) return false;
			else return (this.getId().equals(rytJsyh.getId()));
		}
	}
