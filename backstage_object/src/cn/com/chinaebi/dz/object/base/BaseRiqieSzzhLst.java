...
/**
 * This is an object that contains data related to the riqie_szzh_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="riqie_szzh_lst"
 */

public abstract class BaseRiqieSzzhLst  implements Serializable {

	public static String REF = "RiqieSzzhLst";
	 ...
	 */
	public BaseRiqieSzzhLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RiqieSzzhLst)) return false;
		else {
			cn.com.chinaebi.dz.object.RiqieSzzhLst riqieSzzhLst = (cn.com.chinaebi.dz.object.RiqieSzzhLst) obj;
			if (null == this.getId() || null == riqieSzzhLst.getId()) return false;
			else return (this.getId().equals(riqieSzzhLst.getId()));
		}
	}
