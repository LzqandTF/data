...
/**
 * This is an object that contains data related to the ryt_yzcx table.
...
public abstract class BaseRytYzcx  implements Serializable {

	public static String REF = "RytYzcx";
	 ...
	 */
	public BaseRytYzcx (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytYzcx)) return false;
		else {
			cn.com.chinaebi.dz.object.RytYzcx rytYzcx = (cn.com.chinaebi.dz.object.RytYzcx) obj;
			if (null == this.getId() || null == rytYzcx.getId()) return false;
			else return (this.getId().equals(rytYzcx.getId()));
		}
	}
