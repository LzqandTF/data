...
/**
 * This is an object that contains data related to the original_shengjingbank_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="original_shengjingbank_lst"
 */

public abstract class BaseOriginalShengjingbankLst  implements Serializable {

	public static String REF = "OriginalShengjingbankLst";
	...
	// constructors
	public BaseOriginalShengjingbankLst () {
		initialize();
	}
	 ...
	 */
	public BaseOriginalShengjingbankLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public BaseOriginalShengjingbankLst (
		...
		this.setWhetherzero(whetherzero);
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.OriginalShengjingbankLst)) return false;
		else {
			cn.com.chinaebi.dz.object.OriginalShengjingbankLst originalShengjingbankLst = (cn.com.chinaebi.dz.object.OriginalShengjingbankLst) obj;
			if (null == this.getId() || null == originalShengjingbankLst.getId()) return false;
			else return (this.getId().equals(originalShengjingbankLst.getId()));
		}
	}
