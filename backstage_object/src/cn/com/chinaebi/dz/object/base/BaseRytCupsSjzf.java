...
/**
 * This is an object that contains data related to the ryt_cups_sjzf table.
...
public abstract class BaseRytCupsSjzf  implements Serializable {

	public static String REF = "RytCupsSjzf";
	 ...
	 */
	public BaseRytCupsSjzf (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytCupsSjzf)) return false;
		else {
			cn.com.chinaebi.dz.object.RytCupsSjzf rytCupsSjzf = (cn.com.chinaebi.dz.object.RytCupsSjzf) obj;
			if (null == this.getId() || null == rytCupsSjzf.getId()) return false;
			else return (this.getId().equals(rytCupsSjzf.getId()));
		}
	}
