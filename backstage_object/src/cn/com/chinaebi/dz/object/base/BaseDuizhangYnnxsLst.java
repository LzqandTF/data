...
/**
 * This is an object that contains data related to the duizhang_ynnxs_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="duizhang_ynnxs_lst"
 */

public abstract class BaseDuizhangYnnxsLst  implements Serializable {

	public static String REF = "DuizhangYnnxsLst";
	...
	public static String PROP_JS_AMOUNT = "JsAmount";
	...
	public static String PROP_CURRENY = "Curreny";
	 ...
	 */
	public BaseDuizhangYnnxsLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	private java.lang.String curreny;
	...
	private java.lang.String jsAmount;
	...
	/**
	 * Return the value associated with the column: tradeCode
	 */
	...
	/**
	 * Set the value related to the column: tradeCode
	 * @param tradeCode the tradeCode value
	 */
	...
	/**
	 * Return the value associated with the column: curreny
	 */
	...
	/**
	 * Set the value related to the column: curreny
	 * @param curreny the curreny value
	 */
	public void setCurreny (java.lang.String curreny) {
	...
	/**
	 * Return the value associated with the column: jsAmount
	 */
	public java.lang.String getJsAmount () {
		return jsAmount;
	}

	/**
	 * Set the value related to the column: jsAmount
	 * @param jsAmount the jsAmount value
	 */
	public void setJsAmount (java.lang.String jsAmount) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.DuizhangYnnxsLst)) return false;
		else {
			cn.com.chinaebi.dz.object.DuizhangYnnxsLst duizhangYnnxsLst = (cn.com.chinaebi.dz.object.DuizhangYnnxsLst) obj;
			if (null == this.getId() || null == duizhangYnnxsLst.getId()) return false;
			else return (this.getId().equals(duizhangYnnxsLst.getId()));
		}
	}
