...
/**
 * This is an object that contains data related to the original_szzh_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="original_szzh_lst"
 */

public abstract class BaseOriginalSzzhLst  implements Serializable {

	public static String REF = "OriginalSzzhLst";
	 ...
	 */
	public BaseOriginalSzzhLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.OriginalSzzhLst)) return false;
		else {
			cn.com.chinaebi.dz.object.OriginalSzzhLst originalSzzhLst = (cn.com.chinaebi.dz.object.OriginalSzzhLst) obj;
			if (null == this.getId() || null == originalSzzhLst.getId()) return false;
			else return (this.getId().equals(originalSzzhLst.getId()));
		}
	}
