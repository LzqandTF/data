...
/**
 * This is an object that contains data related to the original_beijingbank_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="original_beijingbank_lst"
 */

public abstract class BaseOriginalBeijingbankLst  implements Serializable {

	public static String REF = "OriginalBeijingbankLst";
	...
	// constructors
	public BaseOriginalBeijingbankLst () {
		initialize();
	}
	 ...
	 */
	public BaseOriginalBeijingbankLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.OriginalBeijingbankLst)) return false;
		else {
			cn.com.chinaebi.dz.object.OriginalBeijingbankLst originalBeijingbankLst = (cn.com.chinaebi.dz.object.OriginalBeijingbankLst) obj;
			if (null == this.getId() || null == originalBeijingbankLst.getId()) return false;
			else return (this.getId().equals(originalBeijingbankLst.getId()));
		}
	}
