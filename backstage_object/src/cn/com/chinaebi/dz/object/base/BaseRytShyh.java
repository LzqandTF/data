...
/**
 * This is an object that contains data related to the ryt_shyh table.
...
public abstract class BaseRytShyh  implements Serializable {

	public static String REF = "RytShyh";
	 ...
	 */
	public BaseRytShyh (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytShyh)) return false;
		else {
			cn.com.chinaebi.dz.object.RytShyh rytShyh = (cn.com.chinaebi.dz.object.RytShyh) obj;
			if (null == this.getId() || null == rytShyh.getId()) return false;
			else return (this.getId().equals(rytShyh.getId()));
		}
	}
