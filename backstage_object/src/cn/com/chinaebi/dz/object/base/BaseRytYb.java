...
/**
 * This is an object that contains data related to the ryt_yb table.
...
public abstract class BaseRytYb  implements Serializable {

	public static String REF = "RytYb";
	 ...
	 */
	public BaseRytYb (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytYb)) return false;
		else {
			cn.com.chinaebi.dz.object.RytYb rytYb = (cn.com.chinaebi.dz.object.RytYb) obj;
			if (null == this.getId() || null == rytYb.getId()) return false;
			else return (this.getId().equals(rytYb.getId()));
		}
	}
