...
/**
 * This is an object that contains data related to the error_data_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="error_data_lst"
 */

public abstract class BaseErrorDataLst  implements Serializable {

	public static String REF = "ErrorDataLst";
	...
	public static String PROP_DOUBLE_CHECK_STATUS = "DoubleCheckStatus";
	...
	public static String PROP_HANDLING_TIME = "HandlingTime";
	...
	public static String PROP_CDZ_REMARK = "CdzRemark";
	...
	public static String PROP_HANDLING_STATUS = "HandlingStatus";
	...
	public static String PROP_ERROR_RESOURCE = "ErrorResource";
	...
	public static String PROP_HANDLER_REMARK = "HandlerRemark";
	...
	public static String PROP_TURN_DOWN_REMARK = "TurnDownRemark";
	 ...
	 */
	public BaseErrorDataLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	private java.lang.String cdzRemark;
	...
	/**
	 * Return the value associated with the column: handling_time
	 */
	public java.util.Date getHandlingTime () {
		return handlingTime;
	}

	/**
	 * Set the value related to the column: handling_time
	 * @param handlingTime the handling_time value
	 */
	public void setHandlingTime (java.util.Date handlingTime) {
	...
	/**
	 * Return the value associated with the column: handler_remark
	 */
	public java.lang.String getHandlerRemark () {
		return handlerRemark;
	}

	/**
	 * Set the value related to the column: handler_remark
	 * @param handlerRemark the handler_remark value
	 */
	public void setHandlerRemark (java.lang.String handlerRemark) {
	...
	/**
	 * Return the value associated with the column: handling_status
	 */
	public java.lang.Integer getHandlingStatus () {
		return handlingStatus;
	}

	/**
	 * Set the value related to the column: handling_status
	 * @param handlingStatus the handling_status value
	 */
	public void setHandlingStatus (java.lang.Integer handlingStatus) {
	...
	/**
	 * Return the value associated with the column: error_resource
	 */
	public java.lang.Integer getErrorResource () {
		return errorResource;
	}

	/**
	 * Set the value related to the column: error_resource
	 * @param errorResource the error_resource value
	 */
	public void setErrorResource (java.lang.Integer errorResource) {
	...
	/**
	 * Return the value associated with the column: double_check_status
	 */
	public java.lang.Integer getDoubleCheckStatus () {
		return doubleCheckStatus;
	}

	/**
	 * Set the value related to the column: double_check_status
	 * @param doubleCheckStatus the double_check_status value
	 */
	public void setDoubleCheckStatus (java.lang.Integer doubleCheckStatus) {
	...
	/**
	 * Return the value associated with the column: cdz_remark
	 */
	public java.lang.String getCdzRemark () {
		return cdzRemark;
	}

	/**
	 * Set the value related to the column: cdz_remark
	 * @param cdzRemark the cdz_remark value
	 */
	public void setCdzRemark (java.lang.String cdzRemark) {
		this.cdzRemark = cdzRemark;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.ErrorDataLst)) return false;
		else {
			cn.com.chinaebi.dz.object.ErrorDataLst errorDataLst = (cn.com.chinaebi.dz.object.ErrorDataLst) obj;
			if (null == this.getId() || null == errorDataLst.getId()) return false;
			else return (this.getId().equals(errorDataLst.getId()));
		}
	}
