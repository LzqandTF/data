...
/**
 * This is an object that contains data related to the original_szgh_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="original_szgh_lst"
 */

public abstract class BaseOriginalSzghLst  implements Serializable {

	public static String REF = "OriginalSzghLst";
	 ...
	 */
	public BaseOriginalSzghLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.OriginalSzghLst)) return false;
		else {
			cn.com.chinaebi.dz.object.OriginalSzghLst originalSzghLst = (cn.com.chinaebi.dz.object.OriginalSzghLst) obj;
			if (null == this.getId() || null == originalSzghLst.getId()) return false;
			else return (this.getId().equals(originalSzghLst.getId()));
		}
	}
