...
/**
 * This is an object that contains data related to the ryt_qilu_yh table.
...
public abstract class BaseRytQiluYh  implements Serializable {

	public static String REF = "RytQiluYh";
	 ...
	 */
	public BaseRytQiluYh (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytQiluYh)) return false;
		else {
			cn.com.chinaebi.dz.object.RytQiluYh rytQiluYh = (cn.com.chinaebi.dz.object.RytQiluYh) obj;
			if (null == this.getId() || null == rytQiluYh.getId()) return false;
			else return (this.getId().equals(rytQiluYh.getId()));
		}
	}
