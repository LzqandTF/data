...
/**
 * This is an object that contains data related to the ryt_gfyh table.
...
public abstract class BaseRytGfyh  implements Serializable {

	public static String REF = "RytGfyh";
	 ...
	 */
	public BaseRytGfyh (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytGfyh)) return false;
		else {
			cn.com.chinaebi.dz.object.RytGfyh rytGfyh = (cn.com.chinaebi.dz.object.RytGfyh) obj;
			if (null == this.getId() || null == rytGfyh.getId()) return false;
			else return (this.getId().equals(rytGfyh.getId()));
		}
	}
