 ...
 */
public class ManualHandlerAgainDzTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements cn.com.chinaebi.dz.webservice.ManualHandlerAgainDzType
{
    private static final long serialVersionUID = 1L;
    
    public ManualHandlerAgainDzTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName ORIGINALDZCOLUMN$8 = 
        new javax.xml.namespace.QName("http://www.dz.chinaebi.com.cn/webservice", "originalDzColumn");
    private static final javax.xml.namespace.QName CHANNELDZCOLUMN$10 = 
        new javax.xml.namespace.QName("http://www.dz.chinaebi.com.cn/webservice", "channelDzColumn");
    private static final javax.xml.namespace.QName INNERTTRADEHANDLER$12 = 
        new javax.xml.namespace.QName("http://www.dz.chinaebi.com.cn/webservice", "innertTradeHandler");
    private static final javax.xml.namespace.QName ISSUEINSTANT$14 = 
    ...
    public java.lang.String[] getOriginalDzColumnArray()
    {
        synchronized (monitor())
        {
            ...
            get_store().find_all_element_users(ORIGINALDZCOLUMN$8, targetList);
    ...
    public java.lang.String getOriginalDzColumnArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(ORIGINALDZCOLUMN$8, i);
            if (target == null)
            {
    ...
    public org.apache.xmlbeans.XmlString xgetOriginalDzColumnArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_element_user(ORIGINALDZCOLUMN$8, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public int sizeOfOriginalDzColumnArray()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ORIGINALDZCOLUMN$8);
        }
    }
    ...
    public void setOriginalDzColumnArray(java.lang.String[] originalDzColumnArray)
    {
        ...
        {
            check_orphaned();
            arraySetterHelper(originalDzColumnArray, ORIGINALDZCOLUMN$8);
        }
    }
    ...
    public void insertOriginalDzColumn(int i, java.lang.String originalDzColumn)
    {
        synchronized (monitor())
        {
            ...
            org.apache.xmlbeans.SimpleValue target = 
                (org.apache.xmlbeans.SimpleValue)get_store().insert_element_user(ORIGINALDZCOLUMN$8, i);
            target.setStringValue(originalDzColumn);
        }
    }
    ...
    public void addOriginalDzColumn(java.lang.String originalDzColumn)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(ORIGINALDZCOLUMN$8);
            target.setStringValue(originalDzColumn);
        }
    }
    ...
    public org.apache.xmlbeans.XmlString insertNewOriginalDzColumn(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().insert_element_user(ORIGINALDZCOLUMN$8, i);
            return target;
        }
    }
    ...
    public org.apache.xmlbeans.XmlString addNewOriginalDzColumn()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().add_element_user(ORIGINALDZCOLUMN$8);
            return target;
        }
    }
    ...
    public void removeOriginalDzColumn(int i)
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(ORIGINALDZCOLUMN$8, i);
        }
    }
    ...
    public java.lang.String[] getChannelDzColumnArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            java.util.List targetList = new java.util.ArrayList();
            get_store().find_all_element_users(CHANNELDZCOLUMN$10, targetList);
            java.lang.String[] result = new java.lang.String[targetList.size()];
            for (int i = 0, len = targetList.size() ; i < len ; i++)
                result[i] = ((org.apache.xmlbeans.SimpleValue)targetList.get(i)).getStringValue();
            return result;
    ...
    public java.lang.String getChannelDzColumnArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(CHANNELDZCOLUMN$10, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public org.apache.xmlbeans.XmlString xgetChannelDzColumnArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_element_user(CHANNELDZCOLUMN$10, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public int sizeOfChannelDzColumnArray()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(CHANNELDZCOLUMN$10);
        }
    }
    ...
    public void setChannelDzColumnArray(java.lang.String[] channelDzColumnArray)
    {
        ...
        {
            check_orphaned();
            arraySetterHelper(channelDzColumnArray, CHANNELDZCOLUMN$10);
        }
    }
    ...
    public void insertChannelDzColumn(int i, java.lang.String channelDzColumn)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = 
                (org.apache.xmlbeans.SimpleValue)get_store().insert_element_user(CHANNELDZCOLUMN$10, i);
            target.setStringValue(channelDzColumn);
        }
    }
    ...
    public void addChannelDzColumn(java.lang.String channelDzColumn)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(CHANNELDZCOLUMN$10);
            target.setStringValue(channelDzColumn);
        }
    }
    ...
    public org.apache.xmlbeans.XmlString insertNewChannelDzColumn(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().insert_element_user(CHANNELDZCOLUMN$10, i);
            return target;
        }
    }
    ...
    public org.apache.xmlbeans.XmlString addNewChannelDzColumn()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().add_element_user(CHANNELDZCOLUMN$10);
            return target;
        }
    }
    ...
    public void removeChannelDzColumn(int i)
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(CHANNELDZCOLUMN$10, i);
        }
    }
    ...
    public boolean getInnertTradeHandler()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_element_user(INNERTTRADEHANDLER$12, 0);
            if (target == null)
            {
                return false;
            }
    ...
    public org.apache.xmlbeans.XmlBoolean xgetInnertTradeHandler()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlBoolean)get_store().find_element_user(INNERTTRADEHANDLER$12, 0);
            return target;
        }
    }
    ...
    public void setInnertTradeHandler(boolean innertTradeHandler)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_element_user(INNERTTRADEHANDLER$12);
            }
    ...
    public void xsetInnertTradeHandler(org.apache.xmlbeans.XmlBoolean innertTradeHandler)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlBoolean)get_store().add_element_user(INNERTTRADEHANDLER$12);
            }
    ...
    public org.apache.xmlbeans.XmlDateTime xgetIssueInstant()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlDateTime)get_store().find_attribute_user(ISSUEINSTANT$14);
            return target;
        }
    }
    ...
    public boolean isSetIssueInstant()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(ISSUEINSTANT$14) != null;
        }
    }
    ...
    public void xsetIssueInstant(org.apache.xmlbeans.XmlDateTime issueInstant)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlDateTime)get_store().add_attribute_user(ISSUEINSTANT$14);
            }
    ...
    public void unsetIssueInstant()
    {
        ...
        {
            check_orphaned();
            get_store().remove_attribute(ISSUEINSTANT$14);
        }
    }
}
