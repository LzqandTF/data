...
/**
 * This is an object that contains data related to the duizhang_bjyh_vas_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="duizhang_bjyh_vas_lst"
 */

public abstract class BaseDuizhangBjyhVasLst  implements Serializable {

	public static String REF = "DuizhangBjyhVasLst";
	 ...
	 */
	public BaseDuizhangBjyhVasLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.DuizhangBjyhVasLst)) return false;
		else {
			cn.com.chinaebi.dz.object.DuizhangBjyhVasLst duizhangBjyhVasLst = (cn.com.chinaebi.dz.object.DuizhangBjyhVasLst) obj;
			if (null == this.getId() || null == duizhangBjyhVasLst.getId()) return false;
			else return (this.getId().equals(duizhangBjyhVasLst.getId()));
		}
	}
