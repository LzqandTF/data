...
/**
 * This is an object that contains data related to the ryt_kuaiqian table.
...
public abstract class BaseRytKuaiqian  implements Serializable {

	public static String REF = "RytKuaiqian";
	 ...
	 */
	public BaseRytKuaiqian (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytKuaiqian)) return false;
		else {
			cn.com.chinaebi.dz.object.RytKuaiqian rytKuaiqian = (cn.com.chinaebi.dz.object.RytKuaiqian) obj;
			if (null == this.getId() || null == rytKuaiqian.getId()) return false;
			else return (this.getId().equals(rytKuaiqian.getId()));
		}
	}
