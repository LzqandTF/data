...
/**
 * This is an object that contains data related to the creditcardpay_trade_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="creditcardpay_trade_lst"
 */

public abstract class BaseCreditcardpayTradeLst  implements Serializable {

	public static String REF = "CreditcardpayTradeLst";
	...
	// constructors
	public BaseCreditcardpayTradeLst () {
		initialize();
	}
	 ...
	 */
	public BaseCreditcardpayTradeLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.CreditcardpayTradeLst)) return false;
		else {
			cn.com.chinaebi.dz.object.CreditcardpayTradeLst creditcardpayTradeLst = (cn.com.chinaebi.dz.object.CreditcardpayTradeLst) obj;
			if (null == this.getId() || null == creditcardpayTradeLst.getId()) return false;
			else return (this.getId().equals(creditcardpayTradeLst.getId()));
		}
	}
