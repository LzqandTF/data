CREATE TABLE `duizhang_hbyh_lst` (
  ...
  `tradeDate` varchar(10) DEFAULT NULL,
  `tradeTime` varchar(10) DEFAULT NULL,
  `payStatus` varchar(20) DEFAULT NULL,
  `tKStatus` varchar(20) DEFAULT NULL,
  `bankHandleStatus` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
