...
/**
 * This is an object that contains data related to the duizhang_zgyh_lst table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="duizhang_zgyh_lst"
 */

public abstract class BaseDuizhangZgyhLst  implements Serializable {

	public static String REF = "DuizhangZgyhLst";
	 ...
	 */
	public BaseDuizhangZgyhLst (java.lang.String id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.DuizhangZgyhLst)) return false;
		else {
			cn.com.chinaebi.dz.object.DuizhangZgyhLst duizhangZgyhLst = (cn.com.chinaebi.dz.object.DuizhangZgyhLst) obj;
			if (null == this.getId() || null == duizhangZgyhLst.getId()) return false;
			else return (this.getId().equals(duizhangZgyhLst.getId()));
		}
	}
