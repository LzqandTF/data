...
/**
 * This is an object that contains data related to the ryt_hengfeng_yh table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="ryt_hengfeng_yh"
 */

public abstract class BaseRytHengfengYh  implements Serializable {

	public static String REF = "RytHengfengYh";
	 ...
	 */
	public BaseRytHengfengYh (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytHengfengYh)) return false;
		else {
			cn.com.chinaebi.dz.object.RytHengfengYh rytHengfengYh = (cn.com.chinaebi.dz.object.RytHengfengYh) obj;
			if (null == this.getId() || null == rytHengfengYh.getId()) return false;
			else return (this.getId().equals(rytHengfengYh.getId()));
		}
	}
