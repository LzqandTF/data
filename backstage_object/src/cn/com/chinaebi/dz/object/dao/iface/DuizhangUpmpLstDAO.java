...
public interface DuizhangUpmpLstDAO {
	 ...
	 */
	public List<DuizhangUpmpLst> findDuizhangUpmpLst(String deduct_stlm_date,boolean whetherTk);
	 ...
	 * @return
	 */
	public boolean findDuizhangUpmpLstCount(String deduct_stlm_date,boolean whetherTk);
