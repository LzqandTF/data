...
/**
 * This is an object that contains data related to the ryt_msyh table.
...
public abstract class BaseRytMsyh  implements Serializable {

	public static String REF = "RytMsyh";
	 ...
	 */
	public BaseRytMsyh (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof cn.com.chinaebi.dz.object.RytMsyh)) return false;
		else {
			cn.com.chinaebi.dz.object.RytMsyh rytMsyh = (cn.com.chinaebi.dz.object.RytMsyh) obj;
			if (null == this.getId() || null == rytMsyh.getId()) return false;
			else return (this.getId().equals(rytMsyh.getId()));
		}
	}
